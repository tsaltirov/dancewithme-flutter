...
// ─── Public entry ─────────────────────────────────────────────────────────────
Future<bool> showAddStudentDialog(
  ...
  final result = await showDialog<bool>(
    ...
    builder: (_) => _AddStudentDialog(schoolId: schoolId),
  );
  return result ?? false;
}
...
class _AddStudentDialog extends StatefulWidget {
  final int schoolId;
  const _AddStudentDialog({required this.schoolId});

  @override
  State<_AddStudentDialog> createState() => _State();
}

class _State extends State<_AddStudentDialog> {
